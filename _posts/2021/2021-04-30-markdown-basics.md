...
## Bold
Bold type is created by add two asterisk (\*\*) around the letter without space.
eg: **I am bold text.**

## Italic
Italic type is created by add one asterisk(\*) or underscore(\_) around the letter without space.
Eg: *I am italic text.*  or _I am italic text as well._

## Bold and Italic
This type is created by adding three asterisk (\*\*\*) around the letters without space.
Eg: ***I am both bold and italic texts.***
